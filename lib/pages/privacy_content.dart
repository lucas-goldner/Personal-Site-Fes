// GENERATED FILE - do not edit by hand. See tool/gen_legal_pages.js.
//
// App privacy policy, served at /privacy.

import 'package:jaspr/dom.dart';
import 'package:jaspr/jaspr.dart';

/// The lines of the page, in order. An empty string renders a blank line.
const _lines = <String>[
  'Privacy App',
  '',
  'Privacy Policy',
  ...
  'which is accessible at app / website unless otherwise defined in this Privacy Policy.',
  '',
  'Information Collection and Use',
  'For a better experience, while using our Service, I may require you to provide us with certain',
  'personally identifiable information, including but not limited to Name, E-Mail, Location, Gender,',
  'Phone number, Password, Birthday. The information that I request will be retained on your',
  'device and is not collected by me in any way.',
  'The app does use third party services that may collect information used to identify you.',
  'Link to privacy policy of third party service providers used by the app',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://firebase.google.com/policies/analytics" target="_blank" rel="noopener noreferrer" > Google Analytics for Firebase </a>',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://firebase.google.com/support/privacy/" target="_blank" rel="noopener noreferrer" > Firebase Crashlytics </a>',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://www.facebook.com/about/privacy/update/printable" target="_blank" rel="noopener noreferrer" > Facebook </a>',
  '',
  '',
  'Log Data',
  'I want to inform you that whenever you use my Service, in a case of an error in the app I collect',
  'data and information (through third party products) on your phone called Log Data. This Log',
  'Data may include information such as your device Internet Protocol (“IP”) address, device',
  ...
  'your device. If you choose to refuse our cookies, you may not be able to use some portions',
  'of this Service.',
  '',
  'Service Providers',
  ...
  'sure therefore that you read them carefully before using the app. You’re not allowed to copy,',
  'or modify the app, any part of the app, or our trademarks in any way. You’re not allowed to',
  'attempt to extract the source code of the app, and you also shouldn’t try to translate the app into other languages, or make derivative versions. The app itself, and all the trade marks,',
  'copyright, database rights and other intellectual property rights related to it, still belong to Lucas Goldner.',
  'Lucas Goldner is committed to ensuring that the app is as useful and efficient as possible. For',
  ...
  'The app / website app stores and processes personal data that you have provided to us, in order to',
  ...
  'programs, compromise your phone’s security features and it could mean that the app / website app',
  'won’t work properly or at all.',
  'The app does use third party services that declare their own Terms and Conditions.',
  'Link to Terms and Conditions of third party service providers used by the app',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://firebase.google.com/terms/analytics" target="_blank" rel="noopener noreferrer" > Google Analytics for Firebase </a>',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://firebase.google.com/terms/crashlytics" target="_blank" rel="noopener noreferrer" > Firebase Chrashlytics </a>',
  '',
  '<a className="lightBlueTextColor hoverLink" href="https://www.facebook.com/legal/terms/plain_text_terms" target="_blank" rel="noopener noreferrer" > Facebook </a>',
  '',
  'You should be aware that there are certain things that Lucas Goldner will not take responsibility',
  'for. Certain functions of the app will require the app to have an active internet connection.',
  'The connection can be Wi-Fi, or provided by your mobile network provider, but Lucas',
  'Goldner cannot take responsibility for the app not working at full functionality if you don’t have',
  ...
  'by your mobile provider for the cost of data for the duration of the connection while',
  ...
  'not the bill payer for the device on which you’re using the app, please be aware that we',
  'assume that you have received permission from the bill payer for using the app.',
  '',
  'Along the same lines, Lucas Goldner cannot always take responsibility for the way you use the',
  'app i.e. You need to make sure that your device stays charged – if it runs out of battery and',
  'you can’t turn it on to avail the Service, Lucas Goldner cannot accept responsibility.',
  'With respect to Lucas Goldner’s responsibility for your use of the app, when you’re using the app,',
  ...
  'make it available to you. Lucas Goldner accepts no liability for any loss, direct or indirect,',
  ...
  'the app to) may change, and you’ll need to download the updates if you want to keep using',
  'the app. Lucas Goldner does not promise that it will always update the app so that it is',
  ...
  'rights and licenses granted to you in these terms will end; (b) you must stop using the app, and',
  ...
  'contact me at app / lucas.goldner@googlemail.com',
];

/// App privacy policy, served at /privacy.
class PrivacyContent extends StatelessComponent {
  const PrivacyContent({super.key});

  @override
  Component build(BuildContext context) {
    return div(id: 'scrollAllow', [
