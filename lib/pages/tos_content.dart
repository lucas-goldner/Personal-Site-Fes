...
//
// Impressum and privacy declaration, served at /tos.
...
const _lines = <String>[
  ...
  '',
  'Lucas Goldner ("us", "we", or "our") operates the app / website (hereinafter referred to as the "Service").',
  '',
  ...
  'same meanings as in our Terms and Conditions, accessible from the app / website app',
  '',
  'Definitions',
  '-----------',
  '',
  ...
  '',
  'We may use the services of various Service Providers in order to process our data more',
  'effectively.',
  '',
  ...
  'device. Other tracking technologies are also used such as beacons, tags and scripts to collect',
  ...
  '--------------------------------------------------------------------------------------------',
  'If you are from the European Economic Area (EEA), Swoboda legal basis for collecting and using',
  ...
  '-----------------',
  '',
  'Lucas Goldner will retain your Personal Data only for as long as is necessary for the',
  ...
  '',
  'Lucas Goldner will also retain Usage Data for internal analysis purposes. Usage Data is',
  ...
  '',
  'Lucas Goldner will take all the steps reasonably necessary to ensure that your data is',
  ...
  '~~~~~~~~~~~~~~~~~~',
  '',
  'Lucas Goldner may disclose your Personal Data in the good faith belief that such action',
  'is necessary to:',
  '',
  ...
  'rights. Lucas Goldner aims to take reasonable steps to allow you to correct, amend,',
  ...
  'where Lucas Goldner relied on your consent to process your personal information.',
  '',
  '',
  ...
  '',
  '* By email: lucas.goldner@googlemail.com',
];

/// Impressum and privacy declaration, served at /tos.
class TosContent extends StatelessComponent {
  const TosContent({super.key});
